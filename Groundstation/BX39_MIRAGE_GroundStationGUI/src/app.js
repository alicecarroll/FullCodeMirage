  ...
  class MockMirageSimulator {
    ...
    generateFrame() {
      ...
      return {
        ...
        outletValue: this.values.outletValue,
        inletValue: this.values.inletValue,
  ...
  function drawAllCharts() {
    ...
    drawChart(dom.thermalChart, history, {
      ...
      series: [
        ...
        { key: "inletC", color: getColorFromCssClass("inlet-temp","background-color"), min: -60, max: 70 },
        { key: "outletC", color: getColorFromCssClass("outlet-temp","background-color"), min: -60, max: 70 },
